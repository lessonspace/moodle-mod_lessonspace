 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class join_space_button_clicked extends \core\event\base
{
    ...
    protected function init()
    {
        ...
        $this->data['crud'] = 'r';
        $this->data['objecttable'] = 'lessonspace';
    }
    ...
    {
        $fieldstovalidate = array('cmid' => "integer", 'spaceid' => "integer");
        foreach ($fieldstovalidate as $field => $shouldbe) {
            ...
            } elseif (gettype($this->other[$field]) != $shouldbe) {
    ...
    {
        return get_string('clickjoin', 'mod_lessonspace');
    }
    ...
    {
        return "User '$this->userid' space with space_id '" .
                $this->other['spaceid'] . "' in course '$this->courseid'";
    }
    ...
    {
        return new \moodle_url('/mod/lessonspace/view.php', array('id' => $this->other['cmid']));
    }
}
